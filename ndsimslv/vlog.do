...
vlog +acc  $MODEL_RTL/dll.sv $MODEL_RTL/aib_io_buffer.sv
vlog +acc  $MODEL_RTL/aib_dcc.v
vlog +acc  $MODEL_RTL/aib_aux_channel.v
vlog +acc  $MODEL_RTL/aib_bitsync.v
vlog +acc  $MODEL_RTL/aib_bsr_red_wrap.v
vlog +acc  $MODEL_RTL/aib_buffx1_top.v
vlog +acc  $MODEL_RTL/aib_ioring.v
vlog +acc  $MODEL_RTL/aib_jtag_bscan.v
vlog +acc  $MODEL_RTL/aib_mux21.v
vlog +acc  $MODEL_RTL/aib_osc_clk.sv
vlog +acc  $MODEL_RTL/aib_redundancy.v
vlog +acc  $MODEL_RTL/aib_rstnsync.v
vlog +acc  $MODEL_RTL/aib_sm.v
vlog +acc  $MODEL_RTL/aib_sr_ms.v
vlog +acc  $MODEL_RTL/aib_sr_sl.v
vlog +acc  $MODEL_RTL/aib_channel.v
vlog +acc  $MODEL_RTL/aib.v
